...
- **No network requests** — the app functions entirely offline. It does not communicate with any server.
- **No data sharing** — your data is never sold, rented, or shared with third parties.

## In-App Purchases

If you make a purchase through the App Store, the transaction is handled entirely by Apple. We do not receive or store your payment information. Apple's own privacy policy governs that transaction. See [Apple's Privacy Policy](https://www.apple.com/legal/privacy/) for details.
